...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = RunCreateResponse200.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[CircularParentRelationshipNotAllowedSubUnitsNotFoundError400, InternalServerErrorError500, RunCreateResponse200, UnitNotFoundSerialNumberError404]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[CircularParentRelationshipNotAllowedSubUnitsNotFoundError400, InternalServerErrorError500, RunCreateResponse200, UnitNotFoundSerialNumberError404]
    """
