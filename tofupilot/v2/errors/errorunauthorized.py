...
from tofupilot.v2.models import errorunauthorized as models_errorunauthorized
...
class ErrorUNAUTHORIZEDData(BaseModel):
    ...
    issues: Optional[List[models_errorunauthorized.ErrorUNAUTHORIZEDIssue]] = None
    r"""An array of issues that were responsible for the error"""


class ErrorUNAUTHORIZED(TofuPilotError):
