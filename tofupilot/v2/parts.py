...
class Parts(BaseSDK):
    ...
    def create(
        ...
        *,
        ...
        request = models.PartCreateRequest(
            number=number,
            name=name,
        ...
        http_res = self.do_request(
            ...
            request=req,
            error_status_codes=["401", "409", "4XX", "500", "5XX"],
            retry_config=retry_config,
        )
    ...
    def delete(
        ...
        *,
        ...
        request = models.PartDeleteRequest(
            number=number,
        )
