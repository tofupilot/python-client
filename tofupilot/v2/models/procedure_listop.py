...
class ProcedureListLinkedRepositoryTypedDict(TypedDict):
    id: str
...
class ProcedureListLinkedRepository(BaseModel):
    id: str
    r"""Unique identifier for the linked repository."""
...
class ProcedureListDataTypedDict(TypedDict):
    ...
    linked_repository: Nullable[ProcedureListLinkedRepositoryTypedDict]
...
class ProcedureListData(BaseModel):
    ...
    linked_repository: Annotated[
        Nullable[ProcedureListLinkedRepository], pydantic.Field(alias="linkedRepository")
    ]
    r"""Linked repository for this procedure."""
