...
class RunGetValidatorTypedDict(TypedDict):
    ...
    expected_value: Nullable[Union[Any, bool, float, str, List[float], List[str]]]
...
class RunGetAggregationTypedDict(TypedDict):
    ...
    value: Nullable[Union[float, str, bool]]
...
class RunGetMeasurement(BaseModel):
    ...
    measured_value: Optional[Union[float, str, bool, List[List[float]], Dict[str, Any], List[Any]]] = None
    r"""The actual measured value."""
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = ["measured_value", "data_series", "aggregations"]
        nullable_fields = ["units", "validators", "aggregations"]
        null_default_fields = []
...
class RunGetSubUnitTypedDict(TypedDict):
    id: str
    r"""Unit ID."""
    serial_number: str
    r"""Unit serial number."""
...
class RunGetResponseTypedDict(TypedDict):
    ...
    sub_units: NotRequired[List[RunGetSubUnitTypedDict]]
...
class RunGetResponse(BaseModel):
    ...
    sub_units: Optional[List[RunGetSubUnit]] = None
    r"""Array of sub-units that had parent changes during this run. Only returned if `all` or `sub_units` is included."""
