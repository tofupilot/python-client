...
UnitListLastRunOutcome = Literal["PASS", "FAIL", "ERROR", "TIMEOUT", "ABORTED"]
...
class UnitListLastRunTypedDict(TypedDict):
    id: str
    r"""Unique identifier for the run."""
    outcome: UnitListLastRunOutcome
    r"""Final result of the test run execution."""
    started_at: datetime
...
class UnitListLastRun(BaseModel):
    id: str
    r"""Unique identifier for the run."""
...
class UnitListDataTypedDict(TypedDict):
    ...
    last_run: NotRequired[Nullable[UnitListLastRunTypedDict]]
...
class UnitListData(BaseModel):
    ...
    last_run: OptionalNullable[UnitListLastRun] = UNSET
    r"""Most recent test run performed on this unit. Null if no runs have been executed."""
