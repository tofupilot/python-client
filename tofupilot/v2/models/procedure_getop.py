...
class ProcedureGetRecentRunTypedDict(TypedDict):
    id: str
    r"""Run ID."""
    started_at: datetime
...
class ProcedureGetRecentRun(BaseModel):
    id: str
    r"""Run ID."""
...
class ProcedureGetResponseTypedDict(TypedDict):
    ...
    recent_runs: List[ProcedureGetRecentRunTypedDict]
...
class ProcedureGetResponse(BaseModel):
    ...
    recent_runs: List[ProcedureGetRecentRun]
    r"""List of recent runs for this procedure."""
