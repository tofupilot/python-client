...
class TestAddChildrenErrors:
    ...
    def test_add_child_parent_not_found(self, client: TofuPilot, auth_type: str, create_test_unit) -> None:
    ...
    def test_add_child_child_not_found(self, client: TofuPilot, auth_type: str, create_test_unit) -> None:
    ...
    def test_add_child_already_has_parent(self, client: TofuPilot, auth_type: str, create_test_unit) -> None:
        ...
        if auth_type == "station":
            ...
            child_id, child_serial, _ = create_test_unit("CHILD-STATION")
        ...
        _, parent1_serial, _ = create_test_unit("PARENT1-CONFLICT")
        _, parent2_serial, _ = create_test_unit("PARENT2-CONFLICT")
        child_id, child_serial, _ = create_test_unit("CHILD-CONFLICT")
    ...
    def test_add_child_serial_number_mismatch(self, client: TofuPilot, auth_type: str, create_test_unit) -> None:
...
class TestRemoveChildrenErrors:
    ...
    def test_remove_child_parent_not_found(self, client: TofuPilot, auth_type: str, create_test_unit) -> None:
    ...
    def test_remove_child_child_not_found(self, client: TofuPilot, auth_type: str, create_test_unit) -> None:
    ...
    def test_remove_child_not_actually_child(self, client: TofuPilot, auth_type: str, create_test_unit) -> None:
    ...
    def test_remove_child_serial_number_mismatch(self, client: TofuPilot, auth_type: str, create_test_unit) -> None:
    ...
    def test_remove_child_from_wrong_parent(self, client: TofuPilot, auth_type: str, create_test_unit) -> None:
